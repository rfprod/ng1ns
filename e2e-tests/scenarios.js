...
describe('AdminUI', function() {
	...
	describe('Login view', function() {
		...
		/*
		*	TODO
		*	use commented code snippets for quick start when it's time for e2e tests
		*/
		...
		it('should open links in new tabs on each flex-item click: github', function(done) {
			...
			browser.switchTo().window(rootHandle).then(function() {
				// CSP returns error, so instead of checking url after click anchor element attributes are checked
